...
Shared [Biome](https://biomejs.dev) preset for the Weber framework — code formatter + linter config used by all `@omnifield/*` packages.
...
```json
{
  ...
  "extends": ["@omnifield/biome-config/biome.json"]
}
```
